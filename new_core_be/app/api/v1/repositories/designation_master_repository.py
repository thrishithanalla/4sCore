"""
Designation Master Repository
Handles all database operations for the designation_master collection.
"""
...
class DesignationMasterRepository(BaseRepository):
    """Repository class for designation master CRUD operations"""

    OBJECTID_FIELDS = ["createdBy", "updatedBy", "deletedBy"]

    def __init__(self, db: AsyncIOMotorDatabase = None):
        super().__init__(Collections.DESIGNATION_MASTER, db)
    ...
    async def find_all(
        ...
        """Find all designations with pagination"""
