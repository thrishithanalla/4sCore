"""
Feedback Master Repository
Handles all database operations for the feedback_master collection.
"""
...
class FeedbackMasterRepository(BaseRepository):
    """Repository class for feedback master CRUD operations"""

    OBJECTID_FIELDS = ["moduleId", "createdBy", "updatedBy", "deletedBy"]

    def __init__(self, db: AsyncIOMotorDatabase = None):
        super().__init__(Collections.FEEDBACK_MASTER, db)
