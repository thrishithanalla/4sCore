"""
District Repository
Handles all database operations for the district_master collection.
"""
...
class DistrictRepository(BaseRepository):
    ...
    def __init__(self, db: AsyncIOMotorDatabase = None):
        super().__init__(Collections.DISTRICT, db)
