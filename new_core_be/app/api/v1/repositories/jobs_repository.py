"""
Jobs Repository
Handles all database operations for the jobs_master collection.
"""
...
class JobsRepository(BaseRepository):
    """Repository class for jobs CRUD operations"""

    OBJECTID_FIELDS = ["moduleId", "createdBy", "updatedBy", "deletedBy"]

    def __init__(self, db: AsyncIOMotorDatabase = None):
        super().__init__(Collections.JOBS, db)
