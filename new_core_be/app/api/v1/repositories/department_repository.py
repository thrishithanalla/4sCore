...
Handles all database operations for the department_master collection.
"""
...
class DepartmentRepository(BaseRepository):
    """Repository class for department CRUD operations"""

    OBJECTID_FIELDS = ["createdBy", "updatedBy", "deletedBy"]

    def __init__(self, db: AsyncIOMotorDatabase = None):
        super().__init__(Collections.DEPARTMENT, db)
