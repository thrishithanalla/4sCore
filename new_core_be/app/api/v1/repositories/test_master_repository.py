...
Handles all database operations for the test_master collection.
"""
...
class TestMasterRepository(BaseRepository):
    """Repository class for test master CRUD operations"""

    OBJECTID_FIELDS = ["moduleId", "createdBy", "updatedBy", "deletedBy"]

    def __init__(self, db: AsyncIOMotorDatabase = None):
        super().__init__(Collections.TEST_MASTER, db)
